...
<head>
    <title>Dancing Club Member List</title>
    <h1>Dancing Club Member List</h1>
</head>
<body>
<form method = "post">
<input type="text" name="dancingmember" placeholder="Search for member's ID or Name" size= "30" required/>
