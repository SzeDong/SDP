...
<head>
    <title>Student Council Club Member List</title>
    <h1>Student Council Club Member List</h1>
</head>
<body>
<form method = "post">
<input type="text" name="studentcouncilmember" placeholder="Search for member's ID or Name" size= "30" required/>
