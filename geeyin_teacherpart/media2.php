...
<head>
    <title>Media Club Member List</title>
    <h1>Media Club Member List</h1>
</head>
<body>
<form method = "post">
<input type="text" name="mediamember" placeholder="Search for member's ID or Name" size= "30" required/>
...
<table>
    ...
    <?php
    $sql = "SELECT * FROM mediamember_list";
